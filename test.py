...
def predict(original, edit1, edit2):
    ...
    print("\nThe first edited sentence is: ", edit1)
    print("\nThe second edited sentence is: ", edit2)
    print("\nProbabilities for the sentences to be equally funny or one of them being funnier:", "\nEqually funny: ",
    ...
    print("\nEdit {} is funnier! :)".format(prediction))
